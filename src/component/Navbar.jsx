  ...
  return (
    <nav className="bg-gray-800 py-4 px-6 shadow-md">
      <div className="container mx-auto flex justify-between items-center">
        ...
        {/* Navigation Links */}
        <div className={`lg:flex lg:items-center lg:space-x-4 ${isOpen ? 'block' : 'hidden'} lg:block absolute lg:static top-full left-0 w-full lg:w-auto bg-gray-800 lg:bg-transparent transition-all duration-300 ease-in-out`}>
          <Link to="/" className="block lg:inline text-gray-300 hover:text-yellow-400 transition py-2 px-4 rounded-md" onClick={closeMenu}>
            Home
          </Link>
          <Link to="/about" className="block lg:inline text-gray-300 hover:text-yellow-400 transition py-2 px-4 rounded-md" onClick={closeMenu}>
            About
          </Link>
          <Link to="/contact" className="block lg:inline text-gray-300 hover:text-yellow-400 transition py-2 px-4 rounded-md" onClick={closeMenu}>
            Contact
          </Link>
          <Link to="/products" className="block lg:inline text-gray-300 hover:text-yellow-400 transition py-2 px-4 rounded-md" onClick={closeMenu}>
            Products
          </Link>
          <Link className="block lg:inline text-gray-300 hover:text-yellow-400 transition py-2 px-4 rounded-md" onClick={closeMenu}>
            <svg
